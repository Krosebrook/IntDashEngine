...
const DepartmentSwitcher: React.FC<Props> = ({ departments, currentDept, onSelect }) => {
  ...
  return (
    <div className="flex flex-col w-full md:w-72">
      ...
      <p className="mt-2 text-[11px] text-slate-400 leading-relaxed font-medium px-1 truncate">
